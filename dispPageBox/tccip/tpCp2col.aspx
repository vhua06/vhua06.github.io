...
<![endif]-->
        ...
        <body class="hp">
                        ...
                        <div class="container">
                            ...
                            <div class="row row-offcanvas row-offcanvas-left">
                                <div class="col-xs-6 col-sm-3 sidebar-offcanvas">
                                    <div id="sidebar">
                                        <!-- <h2 class="sidebar-title"><%=TitleName%></h2> -->
                                        <!-- NAV_SUB START -->
                                        <asp:PlaceHolder ID="NAV_SUB" runat="server" />
                                        <!-- NAV_SUB END -->
                                        <!-- <ul class="list-group">
                                <li class="active"><a href="#" class="list-group-item">受體暴露參數</a></li>
                                <li><a href="#" class="list-group-item">宿命傳輸模式參數</a></li>
                                <li><a href="#" class="list-group-item">建築與環境物參數</a></li>
                                <li><a href="#" class="list-group-item">污染物特性參數</a></li>
                            </ul> -->
                                    </div>
                                    <!--/.sidebar END -->

                                </div>
                                <!--/.sidebar-offcanvas col-xs-6 END -->
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    ...
                                    <div id="Content">
                                        ...
                                        <div class="visible-xs">
                                            <button type="button" id="btnSub" class="btn btn-primary btn-lg btn-block" data-toggle="offcanvas" style="margin-bottom: 30px;"><span class="icon-subnav"></span>次選單</button>
                                        </div>
                                        <!--visible-xs END -->
            ...
            <script src="./dispPageBox/tccip/js/jquery.navgoco.js"></script>
