        ...
        <body onload="resize();">
            <form runat="server">
                <div id="Wrapper">
                    ...
                    <div id="Header">
                        <!-- Logo-->
                        <H1><a href="./dispPageBox/trans.aspx?ddsPageID=DEMOHP"><img src="<%=ResolveUrl("~/dispPageBox/demo/images/logo.jpg") %>" alt="DISP Web Demo - Home" /><em>DISP Web Demo</em></a></H1>
                    ...
                    <div id="Footer">
                        <div class="footDiv">
                            <div class="footLogo">
                                <A href="#"><img src="<%=ResolveUrl("~/dispPageBox/demo/images/logo_footer.gif") %>" alt="DISP Web Demo" /><em>DISP Web Demo</em></A>
                            </div>
